...
function dotenv() {
  dotenv = {
    ...
    _loadEnv: function() {
      return dotenv._getKeysAndValuesFromEnvFilePath(dotenv.env_file_name);
    },
    _loadEnvDotEnvironment: function() {
      return dotenv._getKeysAndValuesFromEnvFilePath(dotenv.env_file_name + "." + dotenv.environment());
    },
    ...
    load: function() {
      return !!dotenv._loadEnv() && !!dotenv._loadEnvDotEnvironment() && !!dotenv._setEnvs();
    },
  };
